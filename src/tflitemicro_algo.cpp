...
extern "C" int tflitemicro_algo_run(uint8_t * ptr_image)
{
	...
	error_reporter->Report("%s: %d | %s: %d | %s: %d | %s: %d\n", kCategoryLabels[0], *(results_ptr), kCategoryLabels[1], *(results_ptr + 1),kCategoryLabels[2], *(results_ptr + 2), kCategoryLabels[3], *(results_ptr + 3));
